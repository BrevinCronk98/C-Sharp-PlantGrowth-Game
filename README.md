...
```
cd Desktop
git clone https://github.com/BrevinCronk98/C-Sharp-PlantGrowth-Game
cd C-Sharp-PlantGrowth-Game(or the file name you created for the main directory of the download)
```
